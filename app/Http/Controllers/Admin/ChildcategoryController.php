...
//        dd('hellow world');
   if ($request->ajax()) {
       ...
       $data=DB::table('childcategories')->leftJoin('categories','childcategories.category_id','categories.id')->
        leftJoin('subcategories','childcategories.subcategory_id','subcategories.id')->select('categories.category_name', 'subcategories.subcategory_name', 'childcategories.*')->get();
    ...
    public function store(Request $request)
    {
        ...
        $data['childcategory_slug'] = $slug = Str::slug($request->childcategory_name, '-');
